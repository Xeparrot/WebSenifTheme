...
namespace Modules\WebSenifTheme\Entities;

use Nwidart\Menus\Presenters\Presenter;

class MenuStyle extends Presenter
{
    /**
     * {@inheritdoc }.
     */
    ...
    {
        return PHP_EOL . '<li class="nav-item">'. PHP_EOL;
    }
    ...
    public function getMenuWithoutDropdownWrapper($item)
    {
        ...
        <a class="nav-link" href="' . $item->getUrl() . '" ' . $item->getAttributes() . '>' . $item->getIcon() . ' <span>' . $item->title . '</span></a></li>' . PHP_EOL;
    }
